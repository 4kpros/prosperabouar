            ...
            <div className="w-full text-white">
                <section className="w-full mt-12">
                    <div className="w-full max-w-screen-xl mx-auto px-4">
                        <Image width={1920} height={1040} layout="responsive" placeholder="blur" priority blurDataURL="/images/profile/setup_preload.webp" src="/images/profile/setup.webp" className="w-full h-auto object-cover" alt="my-setup"/>
                    </div>
                </section>
