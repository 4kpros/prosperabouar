            ...
            <div className="flex flex-col items-center lg:flex-row lg:space-x-8 pt-12">
              <div className="bg-transparent w-3/4 h-3/4">
                <LazyMotion features={domAnimation}>
                  ...
                  >
                    <Image className="w-full h-full object-contain m-0 p-0 bg-my-footer-color" width={622} height={792} objectFit="cover" layout="responsive" priority placeholder="blur" blurDataURL="/images/profile/prosperabouar_preload.webp" src="/images/profile/prosperabouar.webp" alt="Prosper Abouar"/>
                  </m.div>
                </LazyMotion>
              </div>
