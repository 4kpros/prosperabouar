        ...
        <div className="w-full bg-black text-white">
          <section className="w-full">
            <div className="w-full max-w-screen-xl mx-auto px-4">
              <Navbar/>
              <div className="flex md:space-x-8 pt-12">
                ...
                <div className="w-full flex items-center">
                  <div className="">
                    <h1 className="text-4xl font-bold">
                      Salut, Je suis <span className="font-extrabold text-my-orage-color text-5xl ml-2">ABOUAR PROSPER</span>
                    ...
                    <p className="text-my-orage-color text-2xl mt-8">
          ...
          <section className="w-full pt-20">
            <div className="w-full max-w-screen-xl mx-auto px-4">
              ...
              <p className="text-justify text-2xl mt-12">
            ...
            <div className="w-full max-w-screen-xl mx-auto px-4">
              ...
              <div className="w-full mt-12">
                <div className="w-full flex flex-col items-center">
                  <label className="w-1/2 uppercase text-my-gray-color" for="input-name">
                    Nom complet
                  </label>
                  <input className="mt-2 w-1/2 h-12 px-5 text-black text-xl" type="name" id="input-name" placeholder="Votre nom"/>
                </div>
                <div className="w-full flex flex-col items-center mt-8">
                  <label className="w-1/2 uppercase text-my-gray-color" for="input-name">
                    Email
                  </label>
                  <input className="mt-2 w-1/2 h-12 px-5 text-black text-xl" type="email" id="input-name" placeholder="Votre adresse mail"/>
                </div>
                <div className="w-full flex flex-col items-center mt-8">
                  <label className="w-1/2 uppercase text-my-gray-color" for="input-name">
                    Message
                  </label>
                  <textarea className="mt-2 w-1/2 h-32 px-5 py-2 text-black text-xl" id="input-name" placeholder="Votre message"/>
                </div>
