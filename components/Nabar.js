            ...
            <div className="w-full max-w-screen-xl mx-auto">
                <nav className="w-full flex flex-wrap items-center justify-center space-x-12 font-bold text-my-text-color py-8">
                    <Link 
                        ...
                        passHref 
                        scroll={false} 
                        className={`flex flex-col relative ${link1Href === router.pathname ? ` text-my-main-color` : ` `}`}
                        >
                        {link1}
                        {
                    ...
                    <Link 
                        ...
                        passHref 
                        scroll={false} 
                        className={`flex flex-col relative  ${link2Href === router.pathname ? ` text-my-main-color` : ` `}`}
                        >
                        {link2}
                        {
